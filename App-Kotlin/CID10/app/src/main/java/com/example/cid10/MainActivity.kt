...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var dadosTabela = mutableListOf(listOf("Descrição"))
        //var dadosTabela = mutableListOf(listOf("Descrição", "Valor"))
        var termosSimilares: MutableList<List<String>>
        var quantidades_final: MutableList<String> = mutableListOf("Código")
        ...
        Log.d("ASSET_DEBUG", assetFiles?.joinToString("\n") ?: "NO FILES")
        assets.open("CID cidoso - Página1.csv").bufferedReader().useLines { lines ->
        ...
        btnRelatorio.setOnClickListener {
            ...
            // Por enquanto. deixa desligado. Tava salvando tabela vazia
            Log.d("dadosTabela", dadosTabela.toString())
            Log.d("quantidades_final", quantidades_final.toString())
        ...
        btnNovoTermo.setOnClickListener { view ->
            ...
            fun processarSelecao(index: Int) {
                if (index in results.indices) {
                    ...
                    var valor_atualizado = valor.replace(".","")
                        .replace(",", "")
                        //.toDouble()
